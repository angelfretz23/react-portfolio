          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="mi-about-content">
                ...
                <p>
                  I am a Full Stack Software engineer known for being persistent and finding logic 
                  based creative solutions. Thrives in an environment that constantly embraces new technologies.
                  <br />
                  With my free time, I enjoy playing guitar, drone flying, paintball, and hiking.
                </p>
                <ul>
