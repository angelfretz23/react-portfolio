  ...
  const submitHandler = (event) =>{
    ...
    xhr.onreadystatechange = () => {
      ...
      if (xhr.status === 200) {
        ...
        setError(true);
        setMessage('Failed to send the email. Please use your own email service.');
      }
    };
    xhr.send(data);
    }
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="mi-contact-formwrapper">
                <h4>Get In Touch</h4>
                <form action="https://formspree.io/mrgypjjz" method="POST" className="mi-form mi-contact-form" onSubmit={submitHandler}>
